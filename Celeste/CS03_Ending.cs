...
namespace Celeste
{
  public class CS03_Ending : CutsceneEntity
  {
    ...
    private IEnumerator Cutscene(Level level)
    {
      ...
      cs03Ending1.oshiro.Add((Component) new VertexLight(new Vector2(0.0f, -8f), Color.White, 1f, 16, 32));
      ...
      while ((double) cs03Ending1.oshiro.X > (double) (level.Bounds.Left - 16))
      {
